...
@Serializable data class AddEditTransaction(val transactionId: String? = null, val predefinedType: String = "EXPENSE", val preselectedCategoryName: String? = null) : NavKey
